...
export function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex flex-col pt-4 px-4 pb-12 sm:p-8 max-w-7xl mx-auto bg-background">
      <header className="flex items-center justify-between mb-8 bg-white/50 backdrop-blur-md rounded-full px-6 py-3 shadow-sm border border-white">
        <Link href="/" className="flex items-center gap-2 text-primary hover:opacity-80 transition-opacity">
          ...
          <span className="font-sans font-bold text-2xl tracking-tight text-foreground">Dawn<span className="text-primary">Pix</span></span>
        </Link>
