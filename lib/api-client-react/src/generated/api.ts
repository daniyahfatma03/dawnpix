 ...
 */
export const getGetDailyThemeUrl = () => {
  return `/api/themes/daily`;
};

export const getDailyTheme = async (
  options?: RequestInit,
): Promise<DailyTheme> => {
  return customFetch<DailyTheme>(getGetDailyThemeUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetDailyThemeQueryKey = () => {
  return [`/api/themes/daily`] as const;
};

export const getGetDailyThemeQueryOptions = <
  TData = Awaited<ReturnType<typeof getDailyTheme>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getDailyTheme>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetDailyThemeQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getDailyTheme>>> = ({
    signal,
  }) => getDailyTheme({ signal, ...requestOptions });
...
export type GetDailyThemeQueryResult = NonNullable<
  Awaited<ReturnType<typeof getDailyTheme>>
>;
export type GetDailyThemeQueryError = ErrorType<unknown>;

/**
 * @summary Get today's daily theme
 */

export function useGetDailyTheme<
  TData = Awaited<ReturnType<typeof getDailyTheme>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetDailyThemeQueryOptions(options);
